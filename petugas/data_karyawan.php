...
session_start();
include '../koneksi.php';
$result = mysqli_query($koneksi, "SELECT * FROM karyawan ORDER BY id_karyawan");
...
<?php
    if($num > 0) {
        ...
        echo "<td><a id='edit' href ='../petugas/edit.php?id_karyawan=".$data['id_karyawan']."'> Edit</a>  ";
        echo "<td><a id='hapus' href ='../petugas/delete.php?id_karyawan=".$data['id_karyawan']."'onclick='return confirm(\"Apakah anda yakin akan menghapus data\")'>Hapus</a>  ";
        echo "</tr>";
    ...
    <br> </br>
    <a href="../petugas/form-create.php" id="plus">[+] Tambah Data</a>
    <br></br>
    <br>
